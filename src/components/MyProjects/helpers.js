...
export const octopyProjects = [
  ...
  {
    nameProject: "Octopy Rooms",
    description:
      "Plataforma de conferencias que combina diversas salas de interacción, chats de atención inmediata, espacios privados para reuniones de trabajo; almacena archivos en distintos formatos, integra aplicaciones y es ideal para organizar talleres, exposiciones, conferencias, eventos culturales, sociales o deportivos.",
    link: "https://www.octopy-rooms.com/login",
    tools: [
      Images.reactIcon,
      Images.materialIcon,
      Images.javascriptIcon,
  ...
  {
    nameProject: "Novo eventos",
    description:
      "Novo eventos es una plataforma de gestión y control de personal médico para organizar eventos, planeación, autorización de presupuestos, entre otras opciones con diferentes roles.",
    link: "https://www.novoeventos.com/login",
    tools: [Images.reactIcon, Images.bootstrapIcon, Images.javascriptIcon],
  },
];
